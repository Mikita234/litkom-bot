...
- `year` - год
- `month` - месяц
- `sold_quantity` - продано за месяц
...
После деплоя бота загрузите литературу АН в базу данных:
...
Это добавит:
- 📚 **11** книг (Базовый текст, Руководства, и др.)
- 🏷️ **12** брелоков (30 дней, 60 дней, 1 год, и др.)
- 🏅 **2** медали (1 год, 3 года)
